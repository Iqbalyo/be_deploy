...
router.use("/monitoring/unama/v1/informasi-kehadiran", informasiKehadiran); //todo1
...
// router.use("/monitoring/unama/v1/jadwalbelajar", schedules); 
router.use("/monitoring/unama/v1/detailkehadiran", detailKehadiran); 
